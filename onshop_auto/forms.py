...
from .models import CategoriaAuto, AtributoAuto, ProdutoAuto, PerguntaAuto, RespostaAuto, ComplementoModeloAuto, PerguntaModeloAuto, RespostaModeloAuto, Mesa, Codigo, CompradorPedidoAuto, MensagemAuto, QAvaliado, Avaliacao, Garcom, FormaPagamento, Conciliacao
...
class ConciliaForm(forms.ModelForm):
	...
	def __init__(self, *args, **kwargs):
		super(ConciliaForm, self).__init__(*args, **kwargs)
		self.fields['forma'].widget.attrs.update({'class' : 'form-control'})#Necessário para a estilização
		self.fields['valor_pago'].widget.attrs.update({'class' : 'form-control'})#Necessário para a estilização
