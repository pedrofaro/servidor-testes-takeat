...
class Comanda(models.Model):
	...
	STATUS_SIM = 1
	STATUS_SIM_NAO = (
		(STATUS_NAO, 'A Ser Conciliada'), 
		(STATUS_SIM, 'Conciliada'),
	)
	...
	conciliada = models.IntegerField(choices=STATUS_SIM_NAO, default=STATUS_NAO)
...
class Conciliacao(models.Model):
	...
	valor_pago = models.DecimalField(null=True, blank=True, max_digits=8, decimal_places=2)

	def __unicode__(self):
		return self.forma.nome