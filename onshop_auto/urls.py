...
urlpatterns = [
    ...
    url(r'^painel/formas-pagamento/$', views.formas_pagamento, name='formas_pagamento'), #Página de Administração das Formas de Pagamento
    url(r'^painel/formas-pagamento/criar/$', views.editar_formas_pagamento, name='adicionar_forma_pagamento'), #Página de Administração das Formas de Pagamento
    url(r'^painel/formas-pagamento/editar/(?P<id>\d+)/$', views.editar_formas_pagamento, name='editar_forma_pagamento'),
    url(r'^painel/formas-pagamento/deletar/(?P<id>\d+)/$', views.deletar_forma_pagamento, name='deletar_forma_pagamento'),
    url(r'^painel/conciliar-pagamento/(?P<id_comanda>\d+)/$', views.conciliar_comanda, name='conciliar_comanda'),
    url(r'^painel/adicionar-conciliacao/(?P<id_comanda>\d+)/$', views.adicionar_conciliacao, name='adicionar_conciliacao'),
    url(r'^painel/conciliacao/deletar/(?P<id>\d+)/$', views.deletar_conciliacao, name='deletar_conciliacao'),
    url(r'^painel/conciliado/(?P<id_comanda>\d+)/$', views.comanda_conciliada, name='comanda_conciliada'),
