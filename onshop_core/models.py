...
class Estabelecimento(models.Model):
	...
	endereco = models.TextField(default='Rua Tal')
	...
	horario_abertura = models.TimeField(default=datetime.now,null=True, blank=True)
	horario_fechamento = models.TimeField(default=datetime.now,null=True, blank=True)
