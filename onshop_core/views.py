...
def painel(request):
    if request.user.is_authenticated():
    	...
    	try:
    		...
    		push = PushSignal.objects.create(app_id="98e0e059-16c5-49b9-904f-61cc12da39ec", authorization="NDY3YjBiNWUtODRiOS00MmRmLTkzZWQtMjgyOGRmZTkxNDAx")
...
def enviar_email(id):#Função que envia email para o comprador do Pedido
    ...
    send_mail('['+ estabelecimento.nome + '] Obrigado pelo seu Pedido! :) ', message, 'sistema.takeat@gmail.com', [email])
